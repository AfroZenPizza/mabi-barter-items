...
const BarterItem = (props) => {
    return (
        <div className="mx-auto fixed bottom-0 left-0 z-50 justify-between w-full bg-gray-700 text-gray-500">
           <p className="text-center">If you enjoy this tool, please consider supporting future development</p>
